        ...
        {isConnected && (
          <div className="flex items-center gap-4">
            <div className="bg-black/50 backdrop-blur-sm rounded-full px-3 py-1 text-white text-sm flex items-center gap-2">
              ...
              {balance ? `${parseFloat(formatEther(balance.value)).toFixed(4)} XTZ` : '0 XTZ'}
            </div>
          ...
          >
            <div className="bg-gray-800 rounded-xl p-6 max-w-md w-full">
              ...
              <div className="space-y-3 text-gray-300">
                <p>To vote, you need to stake <strong className="text-white">0.0001 XTZ</strong></p>
                ...
                {!hasEnoughBalance && (
                  <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-3">
                    <p className="text-red-400">Insufficient balance. You need at least 0.0001 XTZ to vote.</p>
                  </div>
                )}
            ...
            >
              ...
              <div className="space-y-4 text-center max-w-md">
                ...
                <div className="text-sm text-blue-400 mt-2 p-3 bg-blue-400/10 rounded-lg">
                  💰 Each vote costs 0.0001 XTZ - Win and earn rewards!
                </div>
              </div>
        ...
        {isConnected && !hasVoted && (
          <div className="text-center mt-4">
            <p className="text-gray-400 text-sm">
              💰 Each vote costs <span className="text-white font-medium">0.0001 XTZ</span>
            </p>
